...
const showProducts = (products) => {
    ...
    for (const product of allProducts) {
      ...
      <img class="product-image" src=${image}></img>
        ...
        <p id="display-details" style="display:none">Details:${product.description}</p>
        <p>Rating: ${product.rating.rate} Rating Count: ${product.rating.count}</p>
        <h2>Price: $ ${product.price}</h2>
        <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-success">add to cart</button>
        <button onclick="displayDetails()" id="details-btn" class="btn btn-danger">Details</button>
...
const updateTotal = () => {
    ...
    // const totalPriceValue = document.getElementById("price").innerText;
    // const delChargeValue = document.getElementById("delivery-charge").innerText;
    // const taxValue = document.getElementById("total-tax").innerText;
    // const grandTotal = parseFloat(totalPriceValue) + parseFloat(delChargeValue);
